...
./bin/ramble-cli.sh -f /testroot/testresult/ramble-messages-$HOSTNAME.txt -pu /tmp/ramble-key-store/ramble-cli.pub -pr /tmp/ramble-key-store/ramble-cli -p udp://172.20.128.1:5000 < /testroot/payload
