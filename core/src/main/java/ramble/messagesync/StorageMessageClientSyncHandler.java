...
public class StorageMessageClientSyncHandler extends TypedMessageClientSyncHandler {

  private static final Logger LOG = Logger.getLogger(StorageMessageClientSyncHandler.class);

  private final String id;
  private final DbStore dbStore;

  public StorageMessageClientSyncHandler(String id) {
    this.id = id;
