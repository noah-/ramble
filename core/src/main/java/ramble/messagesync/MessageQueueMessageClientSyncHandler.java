...
public class MessageQueueMessageClientSyncHandler extends TypedMessageClientSyncHandler {
  ...
  public MessageQueueMessageClientSyncHandler(BlockingQueue<RambleMessage.Message> messageQueue, String id) {
